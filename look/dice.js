...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-f929fbca');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-f929fbca');}
...
var brandEl=document.querySelector('.rl-brand-f929fbca');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
